...
```{r}
#3
ozone18_fixed_date <- mdy(ozone18$Date)    # why doesn't this work? 
ozone18$Date <- as.Date(ozone18$Date, format = "%m/%d/%Y")
...
intersect(ozone18_new, ozone19_new, PM18new, PM19new) 
