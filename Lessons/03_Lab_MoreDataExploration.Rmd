...
```{r}
<<<<<<< HEAD
highs <- c(51, 59, 48, 47, 44, 39, 36, 37, 36, 49)
lows <- c(38, 38, 40, 34, 29, 28, 19, 23, 29, 30)
=======
...
```{r}
<<<<<<< HEAD
celcius_outputs <- function(x){
  output1 <- (x - 32) *(5/9)
  return(list(output1 = output1))
}
celcius_highs_output<- celcius_outputs(highs)
celcius_highs_output
celcius_lows_output <- celcius_outputs(lows)
celcius_lows_output


#celcius_highs2 <- vector1 - 32 *(5/9)
#celcius_lows2 <- vector2 - 32 *(5/9)
#forecast_highs <- c("sunny","rain", "partly cloudy", "rainy", "rainy", "sleet", "snow", "partly cloudy", "sleet")
#forecast_lows <- c("sunny","rain", "partly cloudy", "rainy", "rainy", "sleet", "snow", "partly cloudy", "sleet")
=======
...
```{r}
<<<<<<< HEAD
df_temp<- data.frame(highs,lows,celcius_highs_output, celcius_lows_output )
df_temp
=======
