...
Now that we've scraped the data we want into our coding environment, the next step is to wrangle these data into formats we can work with more easily, i.e. a dataframe. Here, we empoly the techniques we've learned earlier in this class to do this and then plot the data. 
